...
branchlist = 'branchlists/evt_jet.txt'
...
get_branches.process(ttH_Even, ttbarSL_Even, 'even4_evt_jet_weights')
get_branches.process(ttH_Odd, ttbarSL_Odd, 'odd4_evt_jet_weights')
