...
branchlist = 'branchlists/bdt_evt_jets.txt'
...
get_branches.process(ttH_Even, ttbarSL_Even, 'even1_bdt_evt_jets_weights')
get_branches.process(ttH_Odd, ttbarSL_Odd, 'odd1_bdt_evt_jets_weights')
