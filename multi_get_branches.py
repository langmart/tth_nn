...
# '01': tt + cc
# 
savedir='/storage/7/lang/nn_data/test'
# get_branches = GetBranches('/storage/7/lang/nn_data', branchlist, categorylist, out_size)
get_branches = GetBranches()
get_branches.process(ttH_Even, ttbarSL_Even, arr_name='even', savedir=savedir, 
        branchlists=branchlists, categories_list=categories_list)
get_branches.process(ttH_Odd, ttbarSL_Odd, arr_name='odd', savedir=savedir, 
        branchlists=branchlists, categories_list=categories_list)
