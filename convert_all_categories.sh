...
echo "Done."
echo ""
echo "Branchlist: Jet_N_Evt.txt"
# python3 get_branches/jet_n_evt_1.py &
python3 get_branches/jet_n_evt_2.py &
# python3 get_branches/jet_n_evt_3.py &
# python3 get_branches/jet_n_evt_4.py
echo "Done."
echo ""
